$(document).ready(function() {
  ...
  $('.pdp_details_block_head a').on('click', function(){
    $(this).closest('.pdp_details_block').find('.pdp_details_block_content').slideToggle();
    $(this).closest('.pdp_details_block').siblings().find('.pdp_details_block_content').slideUp();
  ...
  $(window).scroll(function(){
    ...
    if ($(this).scrollTop() > 0) {
          ...
          $('header').addClass('stickytop_mobile');
          $('#dl-menu, .dl-trigger.mobile_hamburg').addClass('sticky_nav_icon');
            
      } else {
          $('header').removeClass('stickytop_mobile');
          $('#dl-menu, .dl-trigger.mobile_hamburg').removeClass('sticky_nav_icon');
      }
    }
  });
  $('.dl-trigger.mobile_hamburg').on('click', function(){
    $('#dl-menu').find('ul.dl-menu').toggleClass('dl-menuopen');
    $('#dl-menu').toggleClass('showmobilenav');
    $('body').toggleClass('overflowhide');
    $(this).find('.menu_icn, .cross_icn').toggle();
  });
  ...
  $(document).on('click', '.up', function(e){
    ...
    var quantityField = $(this).siblings('input[name='+fieldName+']');
...
//   });
  ...
  $('#inline').click(function(){
    ...
    $('input#q').focus();
    $(this).closest('#main-nav').find('li').css('opacity', 0);
  ...
  $('.close_search_form').click(function(){
    $('.search_form').fadeOut();
    $(this).closest('#main-nav').find('li').css('opacity', 1);
